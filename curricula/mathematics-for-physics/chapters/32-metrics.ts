...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A metric defines inner products and intervals, allowing coordinate effects to be separated from geometric structure and signature. In Euclidean space it measures positive lengths; in spacetime its indefinite sign distinguishes kinds of separation and changes what a coordinate transformation can preserve.", widerConnection: "Metrics prepare the transition from Euclidean calculation to spacetime invariants and symmetry-generated physics. The important habit is to calculate the invariant quantity before interpreting the coordinates used to display it." },
  id: "metrics",
  intuition: {
