...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A nonlinear pendulum is understood by keeping the exact model, its approximation, its invariant, and its numerical error distinct. The small-angle equation is useful because its assumptions and error can be compared with the full energy-based model, not because it replaces the full model everywhere.", widerConnection: "The investigation demonstrates how the whole mathematical spine becomes a defensible physical calculation rather than a collection of techniques. It asks the learner to derive, approximate, compute, check, and explain which discrepancy belongs to which layer of reasoning." },
