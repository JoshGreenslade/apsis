...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A Green function is the response to a localized input; linear superposition then builds the response to distributed forcing while respecting boundaries. The localized input is a limiting distribution, so causality, boundary conditions, and operator domains determine which Green function is meaningful.", widerConnection: "This is the response-theory version of mode decomposition and the direct ancestor of propagators and impulse responses. It gives a reusable way to turn a complicated source into a weighted collection of simple experiments." },
  "id": "green-functions",
  "intuition": {
