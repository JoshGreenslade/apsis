...
const chapter: Chapter = {
  id: "vectors",
  intuition: {
    body: "STUB: Vectors, projections and inner products. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-vectors-trig", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "trigonometry" }),
    numeric("d-vectors-quant", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "quantities" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-vectors", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-vectors-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-vectors-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
