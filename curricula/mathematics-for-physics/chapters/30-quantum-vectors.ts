...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A quantum state is a vector whose inner products determine amplitudes and probabilities, while operators and basis choices determine what can be observed. Components are amplitudes rather than probabilities, and the conjugate inner product is what makes norm and measurement calculations consistent.", widerConnection: "This is the linear-algebra and complex-number structure of quantum mechanics, not a replacement for its physical postulates or dynamics. It prepares the learner to recognise invariant norms, basis changes, and incompatible observables without claiming that notation alone supplies the physics." },
  "id": "quantum-vectors",
  "intuition": {
