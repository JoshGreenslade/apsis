...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A coupled linear system becomes intelligible when its natural modes evolve independently and their superposition reconstructs the original motion. The eigenvectors are not a computational trick added after the physics; they are the patterns the coupling itself permits to evolve cleanly.", widerConnection: "The same mode idea scales from two oscillators to Fourier series, PDEs, and operator-based physics. Once the learner can move between a coupled description and its natural modes, many apparently different systems share one underlying method." },
  id: "coupled-modes",
  intuition: {
