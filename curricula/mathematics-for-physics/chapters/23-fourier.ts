...
const chapter: Chapter = {
  id: "fourier",
  intuition: {
    body: "STUB: Fourier analysis: functions as superpositions. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-fourier-modes", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "coupled-modes" }),
    numeric("d-fourier-int", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "integration-methods" }),
    numeric("d-fourier-complex", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "complex-numbers" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-fourier", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-fourier-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-fourier-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
