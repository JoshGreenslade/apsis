...
const chapter: Chapter = {
  id: "divergence",
  intuition: {
    body: "STUB: Flux, divergence and conservation. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-div-line", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "line-integrals" }),
    numeric("d-div-multi", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "multivariable" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-div", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-div-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-div-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
