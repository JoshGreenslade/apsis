...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "The calculus of variations turns a condition on every admissible path perturbation into the Euler–Lagrange equation for a stationary action. The derivation depends on keeping boundary terms visible and remembering that stationarity does not automatically mean the action is a minimum.", widerConnection: "Action principles unify the earlier differential equations with mechanics, fields, symmetry, and advanced theoretical physics. They offer another route to familiar laws and make symmetry-generated conservation intelligible as a consequence of what the action leaves unchanged." },
  "id": "variation",
  "intuition": {
