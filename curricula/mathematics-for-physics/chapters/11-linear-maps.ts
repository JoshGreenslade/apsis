...
const chapter: Chapter = {
  id: "linear-maps",
  intuition: {
    body: "STUB: Linear maps and systems of equations. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-maps-vectors", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "vectors" }),
    numeric("d-maps-func", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "functions" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-maps", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-maps-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-maps-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
