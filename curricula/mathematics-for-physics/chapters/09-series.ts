...
const chapter: Chapter = {
  id: "series",
  intuition: {
    body: "STUB: Taylor expansions and controlled approximation. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-series-prereq", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "integration-methods" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-series", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-series-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-series-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
