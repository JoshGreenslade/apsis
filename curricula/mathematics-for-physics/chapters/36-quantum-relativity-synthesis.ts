...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "The final comparison is about identifying what transformations preserve, while keeping quantum inner products and spacetime intervals mathematically and physically distinct. The useful analogy is methodological rather than ontological: change the representation, calculate the invariant, and inspect the assumptions before interpreting the result.", widerConnection: "It closes the course by testing whether the learner can carry invariants, representations, limits, and assumptions across different theoretical worlds. The learner should leave able to recognise shared mathematical structure without flattening important differences between the physical theories." },
