...
const chapter: Chapter = {
  ...
  intuition: {
    body: "STUB: Bring it together — invariants in two mathematical worlds. This chapter is not yet written; it is published as a placeholder so the course remains complete and navigable.",
  ...
  diagnostics: [
    numeric("d-qr-quantum", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "quantum-vectors" }),
    numeric("d-qr-metrics", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "metrics" }),
    numeric("d-qr-sym", "STUB: placeholder readiness check.", 1, "1", "STUB", "STUB", { prerequisiteId: "symmetry" }),
  ],
  workedExample: {
    title: "STUB",
    problem: "STUB",
  ...
  fadedExercise: {
    ...
    steps: [numeric("f-qr", "STUB", 1, "1", "STUB", "STUB")],
  },
  retrievalProblems: [
    numeric("r-qr-1", "STUB", 1, "1", "STUB", "STUB"),
    numeric("r-qr-2", "STUB", 2, "1", "STUB", "STUB"),
  ],
  diagram: {
    title: "STUB",
    caption: "STUB",
