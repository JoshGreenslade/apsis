...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A PDE supplies a local evolution law, while boundary and initial data select the global combination of spatial modes that can represent a physical solution. A separated expression is only a candidate until it satisfies the domain, boundaries, initial data, and the assumptions used to derive the equation.", widerConnection: "This unites conservation, operator eigenfunctions, Fourier analysis, and the model boundaries of continuum physics. It is where the course's ideas about local laws, global constraints, and approximation finally operate together on a field." },
  id: "pdes",
  intuition: {
