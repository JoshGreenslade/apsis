...
const chapter: Chapter = {
  theoreticalMinimum: { coreIdea: "A finite-rod diffusion solution must satisfy the conservation law, constitutive relation, boundary data, modal expansion, and decay behaviour together. A formula that solves the local heat equation but violates a boundary condition or positivity expectation is not yet a satisfactory physical solution.", widerConnection: "The capstone reconnects local fields, global balances, eigenmodes, Fourier analysis, Green functions, and numerical checks. It turns the course's repeated local-to-global arguments into one auditable field calculation with explicit assumptions and residual checks." },
  id: "fields-synthesis",
  intuition: {
